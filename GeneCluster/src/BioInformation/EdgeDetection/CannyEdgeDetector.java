...
public class CannyEdgeDetector extends Component implements IEdgeDetector{
	...
	public static CannyEdgeDetector getInstance(){
	...
	public int[] image2pixels(Image image) {
	...
	public BufferedImage getEdgeImage() {
		return toBufferedImage(edgeImage);
	}
    ...
    public static void main(String[] args) throws IOException{
    	Image sourceImage =ImageIO.read(new File("D:/code/original.jpg"));
        ...
        ImageIO.write(edgeDetector.toBufferedImage(edgeImage),"jpg",new File("D:/code/edgeimg.jpg"));
